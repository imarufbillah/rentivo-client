  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-neutral dark:prose-invert mt-8 space-y-6 text-muted-foreground">
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground">3. Property Listings</h2>
          <p>
            ...
            guarantee the availability, pricing, or condition of any
            property. Renters should verify all details directly with the
            owner before making any commitments.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground">7. Termination</h2>
          <p>
